...
//                            System.out.println(this);
        ...
        setBackground(new Background(new BackgroundImage(new Image("file:img/background.png"), BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,
